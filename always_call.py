...
#./play_match.pl sample holdem.nolimit.2p.reverse_blinds.game 100000 0 Alice ./always_call.sh Bob ./always_call.sh
...
def act(state: GameState):
    print(state.cards, state.betting_sequence, state.round)
    return "c"
